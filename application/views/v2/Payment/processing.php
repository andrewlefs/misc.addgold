                    ...
                    <div class="content-sdk" >
                        <form action="#">
                            <div class="header-info text-center"> 
                                <img src="/v1/momo/images/process.svg" class="icon-header" alt="">
                                Giao dịch đang được xử lý <br>
                                <span class="bold">Giao dịch đang được xử lý
                                    Chúng tôi đang kiểm tra và cộng tiền cho bạn 
                                </span>   
                            </div>                            
                        </form>
                    </div>                   
