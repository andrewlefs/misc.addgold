...
<!--        <link rel="stylesheet" type="text/css" href="/v1/inapp/css/google-font.css">-->
        <link rel="stylesheet" href="/v1/nap/css/0061.urlshortener.css">        
        <link rel="stylesheet" type="text/css" href="/v1/inapp/css/bootstrap.min.css">
        <link rel="stylesheet" type="text/css" href="/v1/inapp/css/style.css">
    ...
    <body>
        <div id="sdk-table">
            <div class="sdk-content">
                <div id="body-sdk">   
<!--                    <div class="header-sdk">
                        <div class="back-icon"><a href="#"><img src="/v1/inapp/images/back.svg" class="img-responsive" alt=""></a></div>
                        <div class="mobo-id-header header-text">
                            <?php echo $navTitle ?>
                        </div>
                        <div class=" pull-right">
                            <div class="reload-bt">
                                <img src="/v1/inapp/images/reload.svg" class="img-responsive" alt="">
                            </div>
                            <div class="close-bt">
                                <img src="/v1/inapp/images/close.svg" alt="">
                            </div>
                        </div>
                    </div>-->
