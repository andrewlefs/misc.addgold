...
namespace GraphApi\Http\Adapter;

use GraphApi\Http\Adapter\Curl\AbstractCurl;
use GraphApi\Http\Adapter\Curl\Curl;
use GraphApi\Http\Adapter\Curl\CurlInterface;
